...
$modulePath = "$personalModules\$moduleName"

Write-Host "Installing $moduleName module into $modulePath..."

#Remove the module if it is loaded
Get-Module | Where-Object {$_.name -eq $moduleName} | Remove-Module -Force
